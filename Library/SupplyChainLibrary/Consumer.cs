...
namespace SupplyChainLibrary
{
    ...
    {
        public bool CRUDConsumer(string RecID, string UserTypeID, string FirstName, string Email, string TelephoneNo, string Country, string State, string Address, string StatementType)
        {
            con.Open();
            SqlCommand cmd = new SqlCommand("CRUDConsumer", con);
