...
namespace SupplyChainLibrary
{
    ...
    {
        public bool CRUDAdministrator(string RecID, string UserTypeID, string FirstName, string Email, string TelephoneNo, string Country, string State, string Address, string StatementType)
        {
            con.Open();
