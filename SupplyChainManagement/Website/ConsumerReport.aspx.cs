...
public partial class ConsumerReport : System.Web.UI.Page
{
    ...
    //    try
    //    {
    //        string username = ((ClientMaster)this.Master).Courier;
    //        return username;
    //    }
    //    catch (Exception ex)
    //    {
    ...
    //    try
    //    {
    //        string username = ((ClientMaster)this.Master).CourierID;
    //        return username;
    //    }
    //    catch (Exception ex)
    //    {
    ...
    {
        TableResult.DataSource = objAdm.PopulateDataReport(currentPage, "ConsumerReport", int.Parse(Session["ConsumerID"].ToString ()));
