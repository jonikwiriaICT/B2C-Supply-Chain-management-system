<%@ Page Title="" Language="C#" MasterPageFile="~/SupplyChainMaster.master" AutoEventWireup="true" CodeFile="Warehouse.aspx.cs" Inherits="Warehouse" ValidateRequest ="false"  %>
                            ...
                            <div class="box box-primary">
                                <div class="box-body box-profile">
                                    ...
                                    <asp:Panel ID="PnlWarehouse" runat="server">
                                        ...
                                        <asp:HiddenField ID="warehouse_description" runat="server" />
                                        <div class="row">
                                            <div class="col-md-3">
                                                <label style="font-size: 12px">Warehouse Name</label>
                                            </div>
                                            <div class="col-md-9">
                                                <asp:TextBox ID="warehouse_name" CssClass="form-control " runat="server"></asp:TextBox>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <asp:DropDownList ID="branch_id" CssClass="form-control select2-dropdown" runat="server"></asp:DropDownList>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <label style="font-size: 12px">Warehouse Desc.</label>
                                            </div>
                                            <div class="col-md-9">
