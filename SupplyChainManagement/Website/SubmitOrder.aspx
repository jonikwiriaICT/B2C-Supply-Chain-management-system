<%@ Page Title="" Language="C#" MasterPageFile="~/SupplyChainMaster.master" AutoEventWireup="true" CodeFile="SubmitOrder.aspx.cs" Inherits="SubmitOrder" ValidateRequest ="false"  %>
             ...
             <div id="formView" runat ="server" >
                    ...
                    <div class="panel-heading ">
                        <div class="panel-title ">
                            <h4>Submit Order Information</h4>
                                        ...
                                        <asp:GridView ID="TableResult" runat="server" Font-Size="10px"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderStyle-Width="5%"   HeaderText="Edit Record" ItemStyle-HorizontalAlign="Center" FooterStyle-HorizontalAlign="Center">
                                                    ...
                                                    <i class="fa fa-edit " ></i> &nbsp Submit Order
                                                        </asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
