<%@ Page Title="" Language="C#" MasterPageFile="~/SupplyChainMaster.master" AutoEventWireup="true" CodeFile="ProductType.aspx.cs" Inherits="ProductType" ValidateRequest ="false"  %>
                            ...
                            <div class="box-body box-profile">
                                ...
                                <asp:Panel ID="PnlProductType" runat="server">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <asp:TextBox ID="product_type" CssClass="form-control " runat="server"></asp:TextBox>
