...
public partial class CancelledIssuedOrder : System.Web.UI.Page
{
    ...
    public void bindGrid(int currentPage)
    {
        ...
        TableResult.DataSource = objAdm.PopulateData(currentPage, "GetStockCancelled");
    ...
    protected void TableDelete(object sender, GridViewDeleteEventArgs e)
    {
        try
        {
            ...
            Label1.Text = "Are you sure that you want to Cancel order Record with ID:" + " " + rec_id.Value + " " + " ?";
    ...
    protected void lbDeleteYes_Click(object sender, EventArgs e)
    {
        try
        {
            if (Administrator() == "1")
            {
                ...
                if (objAdm.CancelRetailerOrder(rec_id.Value, sTbl) == true)
                {
                    DisplaySuccess("Order Cancelled successfully.");
                    LoadGrid();
