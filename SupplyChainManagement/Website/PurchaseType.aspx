<%@ Page Title="" Language="C#" MasterPageFile="~/SupplyChainMaster.master" AutoEventWireup="true" CodeFile="PurchaseType.aspx.cs" Inherits="PurchaseType" ValidateRequest="false" %>
                    ...
                    <div class="panel">
                        <div class="panel-heading ">
                            <div class="panel-title ">
                                <h4>Purchase Type Information</h4>
                        ...
                        <div class="panel-body">
                            <div class="box box-primary">
                                <div class="box-body box-profile">
                                    ...
                                    <br />
                                    <br />
                                    <asp:Panel ID="PnlPurchaseType" runat="server">
                                        <asp:HiddenField ID="rec_id" runat="server" />
                                        <asp:HiddenField ID="type_description" runat="server" />
                                        <div class="row">
                                            <div class="col-md-3">
                                                <label style="font-size: 12px">Purchase Type</label>
                                            </div>
                                            <div class="col-md-9">
                                                <asp:TextBox ID="purchase_type_name" CssClass="form-control " runat="server"></asp:TextBox>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <label style="font-size: 12px">Purchase Desc.</label>
                                            </div>
                                            <div class="col-md-9">
