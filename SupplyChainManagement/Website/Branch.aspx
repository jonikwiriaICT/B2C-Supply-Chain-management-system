<%@ Page Title="" Language="C#" MasterPageFile="~/SupplyChainMaster.master" AutoEventWireup="true" CodeFile="Branch.aspx.cs" Inherits="Branch" ValidateRequest ="false"  %>
                        ...
                        <div class="box box-primary">
                            <div class="box-body box-profile">
                                ...
                                <asp:Panel ID="PnlBranch" runat="server">
                                    ...
                                    <asp:HiddenField ID="branch_description" runat="server" />
                                    <div class="row">
                                        <div class="col-md-3">
                                            <label style="font-size: 12px">Branch Name</label>
                                        </div>
                                        <div class="col-md-9">
                                            <asp:TextBox ID="branch_name" CssClass="form-control " runat="server"></asp:TextBox>
                                     ...
                                     <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <asp:TextBox ID="contact_person" CssClass="form-control " runat="server"></asp:TextBox>
                                    ...
                                    <div class="row">
                                     ...
                                     <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <asp:TextBox ID="phone_no" CssClass="form-control " runat="server"></asp:TextBox>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <asp:DropDownList ID="currency_id" CssClass ="form-control" runat="server"></asp:DropDownList>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <label style="font-size: 12px">Branch Desc.</label>
                                        </div>
                                        <div class="col-md-9">
