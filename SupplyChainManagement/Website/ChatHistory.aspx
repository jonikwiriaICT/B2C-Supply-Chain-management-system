<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChatHistory.aspx.cs" Inherits="ChatHistory" ValidateRequest="false" %>
                                ...
                                <div class="box-header with-border">
                                    ...
                                    <div class="btn-group pull-right ">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            <li>
                                                <asp:LinkButton ID="lnkDeleChatHistory" OnClick="DeleteChat" runat="server"><i class=" fa fa-line-chart"></i>Delete Chat History</asp:LinkButton>
                                                <asp:LinkButton ID="lnkGiveFeedback" OnClick="NavigateFeedback" runat="server"><i class=" fa fa-eyedropper"></i>Give Feedback</asp:LinkButton>
