<%@ Page Title="" Language="C#" MasterPageFile="~/ClientMaster.master" AutoEventWireup="true" CodeFile="ConsumerRegister.aspx.cs" Inherits="ConsumerRegister" ValidateRequest ="false"  %>
                            ...
                            <div class="box box-primary">
                                <div class="box-body box-profile">
                                    ...
                                    <asp:Panel ID="PnlConsumer" runat="server">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <label style="font-size: 12px">User Type</label>
                                            </div>
                                            <div class="col-md-9">
                                                <asp:DropDownList ID="UserTypeID" CssClass="form-control" runat="server"></asp:DropDownList>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <label style="font-size: 12px">Telephone No.</label>
                                            </div>
                                            <div class="col-md-9">
                                                <asp:TextBox ID="telephone_no" CssClass="form-control" runat="server"></asp:TextBox>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <asp:TextBox ID="address" TextMode="MultiLine" Rows="3" CssClass="form-control" runat="server"></asp:TextBox>
                                        ...
                                        <div class="table-responsive">
                                            <asp:GridView ID="TableResult" runat="server" Font-Size="10px"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderStyle-Width="5%" HeaderText="Edit Record" Visible ="true"  ItemStyle-HorizontalAlign="Center" FooterStyle-HorizontalAlign="Center">
                                                        <ItemTemplate>
