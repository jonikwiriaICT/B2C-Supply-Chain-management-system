<%@ Page Title="" Language="C#" MasterPageFile="~/SupplyChainMaster.master" AutoEventWireup="true" CodeFile="RetailerSalesReport.aspx.cs" Inherits="RetailerSalesReport" ValidateRequest ="false"  %>
                    ...
                    <div class="panel">
                        <div class="panel-heading ">
                            <div class="panel-title ">
                                <h4>Retailer Stock Information</h4>
                ...
                <div id="TableView" runat="server">
                    <div class="nav-tabs-custom">
                        <div class="panel ">
                            <div class="panel-heading ">
                                <div class="panel-title ">
                                    <h4>Retailer Sales Report Record</h4>
                                    <br />
                                </div>
                            </div>
                            <div class="panel-body">
