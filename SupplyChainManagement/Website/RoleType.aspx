<%@ Page Title="" Language="C#" MasterPageFile="~/SupplyChainMaster.master" AutoEventWireup="true" CodeFile="RoleType.aspx.cs" Inherits="RoleType" ValidateRequest ="false"  %>
                                ...
                                <div class="box-body box-profile">
                                    ...
                                    <asp:Panel ID="PnlUserType" runat="server">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <asp:TextBox ID="user_type" CssClass="form-control " runat="server"></asp:TextBox>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <label style="font-size: 12px">User Type Desc.</label>
                                            </div>
                                            <div class="col-md-9">
