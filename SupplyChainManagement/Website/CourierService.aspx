<%@ Page Title="" Language="C#" MasterPageFile="~/SupplyChainMaster.master" AutoEventWireup="true" CodeFile="CourierService.aspx.cs" Inherits="CourierService" ValidateRequest ="false"  %>
                                        ...
                                        <asp:GridView ID="TableResult" runat="server" Font-Size="10px"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderStyle-Width="5%"   HeaderText="Edit Record" ItemStyle-HorizontalAlign="Center" FooterStyle-HorizontalAlign="Center">
                                                    ...
                                                    <i class="fa fa-edit " ></i> &nbsp Accept
                                                        </asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
