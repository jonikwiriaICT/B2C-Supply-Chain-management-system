<%@ Page Title="" Language="C#" MasterPageFile="~/SupplyChainMaster.master" AutoEventWireup="true" CodeFile="RetailerStock.aspx.cs" Inherits="RetailerStock" ValidateRequest="false" %>
                ...
                <div id="TableView" runat="server">
                    <div class="nav-tabs-custom">
                        <div class="panel ">
                            <div class="panel-heading ">
                                <div class="panel-title ">
                                    <h4>Retailer Stock Report Record</h4>
                                    <br />
                                </div>
                            </div>
                            <div class="panel-body">
