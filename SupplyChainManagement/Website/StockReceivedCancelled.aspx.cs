...
public partial class StockReceivedCancelled : System.Web.UI.Page
{
    ...
    protected void TableDelete(object sender, GridViewDeleteEventArgs e)
    {
        try
        {
            ...
            Label1.Text = "Are you sure that you want to Cancel order with ID:" + " " + rec_id.Value + " " + " ?";
    ...
    protected void lbDeleteYes_Click(object sender, EventArgs e)
    {
        try
        {
            if (Administrator() == "1")
            {
                ...
                if (objAdm.ConfirmRetailCancel(rec_id.Value) == true)
                {
    ...
    protected void SaveChangesClicked(object sender, EventArgs e)
    {
        try
        {
            if (Administrator() == "1")
            {
                ...
                if (itrig == 0)
                {
                    if (objAdm.CRUD(rec_id.Value, "3") == true)
                    {
                        LoadGrid();
                        DisplaySuccess(objAdm.ErrorMessage);
