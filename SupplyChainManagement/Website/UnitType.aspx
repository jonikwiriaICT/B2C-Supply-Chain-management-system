<%@ Page Title="" Language="C#" MasterPageFile="~/SupplyChainMaster.master" AutoEventWireup="true" CodeFile="UnitType.aspx.cs" Inherits="UnitType" ValidateRequest ="false"  %>
                        ...
                        <div class="panel-body">
                            <div class="box box-primary">
                                <div class="box-body box-profile">
                                    ...
                                    <br />
                                    <br />
                                    <asp:Panel ID="PnlUnitType" runat="server">
                                        <asp:HiddenField ID="rec_id" runat="server" />
                                        <asp:HiddenField ID="unit_description" runat="server" />
                                        <div class="row">
                                            <div class="col-md-3">
                                                <label style="font-size: 12px">Unit Type</label>
                                            </div>
                                            <div class="col-md-9">
                                                <asp:TextBox ID="unit_type" CssClass="form-control " runat="server"></asp:TextBox>
