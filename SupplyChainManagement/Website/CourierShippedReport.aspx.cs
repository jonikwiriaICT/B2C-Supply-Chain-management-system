...
public partial class CourierShippedReport : System.Web.UI.Page
{
    ...
    {
        TableResult.DataSource = objAdm.PopulateDataReport(currentPage, "CourierReport", int.Parse(ManufacturerID()));
