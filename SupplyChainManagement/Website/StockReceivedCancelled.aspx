<%@ Page Title="" Language="C#" MasterPageFile="~/SupplyChainMaster.master" AutoEventWireup="true" CodeFile="StockReceivedCancelled.aspx.cs" Inherits="StockReceivedCancelled" ValidateRequest ="false"  %>
             ...
             <div id="formView" runat ="server" >
                    ...
                    <div class="panel-heading ">
                        <div class="panel-title ">
                            <h4>Stock Received Information</h4>
             ...
             <div class="col-md-12">
              <div id="TableView" runat ="server" >
                    ...
                    <div class="panel ">
                        <div class="panel-heading ">
                            <div class="panel-title ">
                                <h4>Stock Received Cancelled Record</h4>
                                        ...
                                        <asp:GridView ID="TableResult" runat="server" Font-Size="10px"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderStyle-Width="5%" HeaderText="Edit Record" Visible ="false"  ItemStyle-HorizontalAlign="Center" FooterStyle-HorizontalAlign="Center">
                                                    ...
                                                    <i class="fa fa-edit " ></i>&nbsp Recieved Order
                                                        </asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
