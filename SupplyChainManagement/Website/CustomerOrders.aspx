<%@ Page Title="" Language="C#" MasterPageFile="~/SupplyChainMaster.master" AutoEventWireup="true" CodeFile="CustomerOrders.aspx.cs" Inherits="CustomerOrders" ValidateRequest ="false"  %>
                                ...
                                <asp:Panel ID="PnlTransactionStock" runat="server">
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <asp:TextBox ID="flag_on" Enabled ="false"  CssClass="form-control " runat="server"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
