<%@ Page Title="" Language="C#" MasterPageFile="~/SupplyChainMaster.master" AutoEventWireup="true" CodeFile="UpdateLocation.aspx.cs" Inherits="UpdateLocation" ValidateRequest ="false"  %>
             ...
             <div id="formView" runat ="server" >
                    ...
                    <div class="panel-heading ">
                        <div class="panel-title ">
                            <h4>Update Location Information</h4>
                    ...
                    <div class="panel-body">
                        <div class="box box-primary">
                            <div class="box-body box-profile">
                                ...
                                <br /><br />
                                <asp:Panel ID="PnlCourierShipment" runat="server">
                                    <asp:HiddenField ID="rec_id" runat="server" />
                                  
                                    <div class="row">
                                        <div class="col-md-3">
                                            <label style="font-size: 12px">Product Address</label>
                                        </div>
                                        <div class="col-md-9">
                                            <asp:TextBox ID="product_address"   CssClass="form-control " runat="server"></asp:TextBox>
                                        </div>
                                        ...
                                        <asp:GridView ID="TableResult" runat="server" Font-Size="10px"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderStyle-Width="5%"   HeaderText="Edit Record" ItemStyle-HorizontalAlign="Center" FooterStyle-HorizontalAlign="Center">
                                                    ...
                                                    <i class="fa fa-edit " ></i> &nbsp Update Location
                                                        </asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
