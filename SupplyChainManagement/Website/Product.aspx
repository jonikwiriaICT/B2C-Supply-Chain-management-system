<%@ Page Title="" Language="C#" MasterPageFile="~/SupplyChainMaster.master" AutoEventWireup="true" CodeFile="Product.aspx.cs" Inherits="Product" ValidateRequest ="false" %>
                            ...
                            <div class="box box-primary">
                                <div class="box-body box-profile">
                                    ...
                                    <asp:Panel ID="PnlProduct" runat="server">
                                        ...
                                        <asp:HiddenField ID="product_profile" runat="server" />
                                          <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                <asp:DropDownList ID="manufacturer_id" CssClass="form-control select2-dropdown" runat="server"></asp:DropDownList>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <label style="font-size: 12px">Unit Type</label>
                                            </div>
                                            <div class="col-md-9">

                                                <asp:DropDownList ID="unit_typeID" CssClass="form-control select2-dropdown" runat="server"></asp:DropDownList>

                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-3">
                                                <label style="font-size: 12px">Product Type</label>
                                            </div>
                                            <div class="col-md-9">

                                                <asp:DropDownList ID="product_type_id" CssClass="form-control select2-dropdown" runat="server"></asp:DropDownList>

                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-3">
                                                <label style="font-size: 12px">Buying Price</label>
                                            </div>
                                            <div class="col-md-9">
                                                <asp:TextBox ID="buying_price" CssClass="form-control decimal" runat="server"></asp:TextBox>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                <asp:TextBox ID="selling_price" CssClass="form-control decimal" runat="server"></asp:TextBox>

                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-3">
                                                <label style="font-size: 12px">Product Profile</label>
                                            </div>
                                            <div class="col-md-9">
