...
public partial class CustomerSentiment : System.Web.UI.Page
{
    SysAdminModel objAdm = new SysAdminModel();
    DataSet ds;
    DataTable Dt;
    public string ChartSentiment = string.Empty;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (Administrator() == "1" || ManufacturerID()=="1" || Retailer()=="1")
            {
                if (!IsPostBack)
                {
                    LoadGrid();
    ...
    private void GetChart()
    {
        try
        {
            ...
            ChartSentiment = objAdm.chartGender;
        }
        catch(Exception ex)
        {
    ...
    {
        TableResult.DataSource = objAdm.PopulateData(currentPage, "GetComment");
