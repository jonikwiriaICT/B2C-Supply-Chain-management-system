...
public partial class RetailerStock : System.Web.UI.Page
{
    ...
    {
        TableResult.DataSource = objAdm.PopulateDataReport(currentPage, "RemainStockReport", int.Parse(ManufacturerID()));
