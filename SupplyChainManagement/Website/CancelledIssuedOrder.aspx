<%@ Page Title="" Language="C#" MasterPageFile="~/SupplyChainMaster.master" AutoEventWireup="true" CodeFile="CancelledIssuedOrder.aspx.cs" Inherits="CancelledIssuedOrder" ValidateRequest ="false"  %>
             ...
             <div id="formView" runat ="server" >
                    ...
                    <div class="panel-heading ">
                        <div class="panel-title ">
                            <h4>Stock Issued Information</h4>
                    ...
                    <div class="panel-body">
                        <div class="box box-primary">
                            <div class="box-body box-profile">
                                ...
                                <br /><br />
                                <asp:Panel ID="PnlStockIssued" runat="server">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-9">
                                            <asp:TextBox ID="order_id" Enabled ="false"  CssClass="form-control " runat="server"></asp:TextBox>

                                        </div>
                                    </div>
                                      <div class="row">
                                        <div class="col-md-3">
                                            <label style="font-size: 12px">Product ID</label>
                                        </div>
                                        <div class="col-md-9">
                                            <asp:TextBox ID="product_id" Enabled ="false"  CssClass="form-control " runat="server"></asp:TextBox>
             ...
             <div class="col-md-12">
              <div id="TableView" runat ="server" >
                    ...
                    <div class="panel ">
                        <div class="panel-heading ">
                            <div class="panel-title ">
                                <h4>Cancelled Stock Issued Record</h4>
                                        ...
                                        <asp:GridView ID="TableResult" runat="server" Font-Size="10px"
                                            ...
                                            <Columns>
                                                <asp:TemplateField HeaderStyle-Width="7%" HeaderText="Delete Record" Visible="false" HeaderStyle-CssClass=" thead-default" ItemStyle-HorizontalAlign="Center" FooterStyle-HorizontalAlign="Center">
                                                    ...
                                                    <i class="fa fa-trash"></i>&nbsp Cancel Order
                                                        </asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderStyle-Width="5%" Visible ="false"  HeaderText="Edit Record" ItemStyle-HorizontalAlign="Center" FooterStyle-HorizontalAlign="Center">
                                                    ...
                                                    <i class="fa fa-edit " ></i>&nbsp Ship Order
                                                        </asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer bg-whitesmoke br">
                    ...
                    <asp:LinkButton ID="lnkDelete" CssClass="btn btn-sm btn-danger" OnClick="lbDeleteYes_Click" runat="server"><i class="fa fa-trash"></i>&nbsp Cancel Order</asp:LinkButton>
                </div>
            </div>
        </div>
    </div>
