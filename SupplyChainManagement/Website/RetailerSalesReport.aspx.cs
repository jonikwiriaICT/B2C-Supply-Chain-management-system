...
public partial class RetailerSalesReport : System.Web.UI.Page
{
    ...
    {
        TableResult.DataSource = objAdm.PopulateDataReport(currentPage, "RetailerSalesReports", int.Parse(ManufacturerID()));
