<%@ Page Title="" Language="C#" MasterPageFile="~/SupplyChainMaster.master" AutoEventWireup="true" CodeFile="ManufacturerReport.aspx.cs" Inherits="ManufacturerReport" ValidateRequest ="false"  %>
             ...
             <div class="col-md-12">
              <div id="TableView" runat ="server" >
                    ...
                    <div class="panel ">
                        <div class="panel-heading ">
                            <div class="panel-title ">
                                <h4>Manufacturer Sales Report Record</h4>
