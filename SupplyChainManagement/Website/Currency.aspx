<%@ Page Title="" Language="C#" MasterPageFile="~/SupplyChainMaster.master" AutoEventWireup="true" CodeFile="Currency.aspx.cs" Inherits="Currency" ValidateRequest="false" %>
                        ...
                        <div class="box box-primary">
                            <div class="box-body box-profile">
                                ...
                                <asp:Panel ID="PnlCurrency" runat="server">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <label style="font-size: 12px">Currency Name</label>
                                        </div>
                                        <div class="col-md-9">
                                            <asp:TextBox ID="currency_name" CssClass="form-control " runat="server"></asp:TextBox>

                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-3">
                                            <label style="font-size: 12px">Currency Code</label>
                                        </div>
                                        <div class="col-md-9">
                                            <asp:TextBox ID="currency_code" CssClass="form-control " runat="server"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-3">
                                            <label style="font-size: 12px">Currency Desc.</label>
                                        </div>
                                        <div class="col-md-9">
